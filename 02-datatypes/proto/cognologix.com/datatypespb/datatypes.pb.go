...
var file_datatypes_proto_rawDesc = []byte{
	...
	0x22, 0xcb, 0x01, 0x0a, 0x12, 0x45, 0x6e, 0x75, 0x6d, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x05, 0x50, 0x4c, 0x55, 0x54, 0x4f, 0x10, 0x09, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x06, 0x22, 0x2d,
...
var file_datatypes_proto_goTypes = []interface{}{
	...
	(*ScalarDataTypeRequest)(nil),  // 1: ScalarDataTypeRequest
	(*ScalarDataTypeResponse)(nil), // 2: ScalarDataTypeResponse
	(*EnumerationRequest)(nil),     // 3: EnumerationRequest
	(*EnumerationResponse)(nil),    // 4: EnumerationResponse
}
var file_datatypes_proto_depIdxs = []int32{
	0, // 0: EnumerationRequest.planet:type_name -> EnumerationRequest.Planet
	1, // 1: DataTypeService.TestScalarDataType:input_type -> ScalarDataTypeRequest
	3, // 2: DataTypeService.TestEnumDataType:input_type -> EnumerationRequest
	2, // 3: DataTypeService.TestScalarDataType:output_type -> ScalarDataTypeResponse
	4, // 4: DataTypeService.TestEnumDataType:output_type -> EnumerationResponse
